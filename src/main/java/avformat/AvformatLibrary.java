...
public interface AvformatLibrary extends Library {
	 ...
	 * @deprecated use the safer methods {@link #av_metadata_get(avformat.AVMetadata, java.lang.String, avformat.AVMetadataTag, int)} and {@link #av_metadata_get(avformat.AVMetadata, com.sun.jna.Pointer, avformat.AVMetadataTag, int)} instead
	 */
	...
	@Deprecated 
	AVMetadataTag av_metadata_get(AVMetadata m, Pointer key, AVMetadataTag prev, int flags);
	/**
	 * Gets a metadata element with matching key.<br>
	 * @param prev Set to the previous matching element to find the next.<br>
	 *             If set to NULL the first matching element is returned.<br>
	 ...
	 */
	@Mangling({"_Z15av_metadata_getP10AVMetadataPKcPK13AVMetadataTagi", "?av_metadata_get@@YAPAUAVMetadataTag@@PA10AVMetadataPADPAUAVMetadataTag@@H@Z"}) 
	AVMetadataTag av_metadata_get(AVMetadata m, String key, AVMetadataTag prev, int flags);
	/**
	...
	void av_metadata_conv(AVFormatContext ctx, AVMetadataConv d_conv, AVMetadataConv s_conv);
	/**
	...
	/**
	 * Original signature : <code>void ff_metadata_demux_compat(AVFormatContext*)</code><br>
	 * <i>native declaration : src/main/headers/libavformat/metadata.h:43</i>
	 */
	@Mangling({"_Z24ff_metadata_demux_compatP15AVFormatContext", "?ff_metadata_demux_compat@@YAXPAUAVFormatContext@@@Z"}) 
	void ff_metadata_demux_compat(AVFormatContext s);
	/**
	 * Original signature : <code>void ff_metadata_mux_compat(AVFormatContext*)</code><br>
	 * <i>native declaration : src/main/headers/libavformat/metadata.h:44</i>
	 */
	@Mangling({"_Z22ff_metadata_mux_compatP15AVFormatContext", "?ff_metadata_mux_compat@@YAXPAUAVFormatContext@@@Z"}) 
	void ff_metadata_mux_compat(AVFormatContext s);
	/**
	 * Original signature : <code>void metadata_conv(AVMetadata**, const AVMetadataConv*, const AVMetadataConv*)</code><br>
	 * <i>native declaration : src/main/headers/libavformat/metadata.h:47</i>
	 */
	@Mangling({"_Z13metadata_convPP10AVMetadataPK14AVMetadataConvPK14AVMetadataConv", "?metadata_conv@@YAXPAPA10AVMetadataPA14AVMetadataConvPA14AVMetadataConv@Z"}) 
	void metadata_conv(PointerByReference pm, AVMetadataConv d_conv, AVMetadataConv s_conv);
	/**
